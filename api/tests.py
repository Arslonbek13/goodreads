...
class BookReviewAPITestCase(APITestCase):
    def setUp(self):
        self.user = CustomUser.objects.create(username="Arslonbek", first_name="Arslonbek")
        self.user.set_password("Arslonbek0413")
        self.user.save()
    ...
    def test_book_review_detail(self):
        ...
        self.assertEqual(response.data['user']['first_name'], "Arslonbek")
        self.assertEqual(response.data['user']['username'], "Arslonbek")
    ...
    def test_book_review_list(self):
        user_two = CustomUser.objects.create(username="arslonbek", first_name="Arslonbek")
        book = Book.objects.create(title="Book1", description="Description1", isbn="123121")
        br = BookReview.objects.create(book=book, user=self.user, stars_given=5, comment="Very good book")
